...
std::list<std::shared_ptr<Specialist>> PositionalObject::removeSpecialists() {
    std::list<std::shared_ptr<Specialist>> tmp = specialists;
    specialists.clear();
...
std::shared_ptr<Specialist> PositionalObject::removeSpecialist(std::shared_ptr<Specialist> specialist) {
    for(auto it = this->specialists.begin(); it != this->specialists.end(); it++) {
...
void PositionalObject::postCombatSpecialistPhase(Game* game, std::shared_ptr<PositionalObject> other) {
    if(controlsSpecialist(SpecialistType::REVERED_ELDER) || other->controlsSpecialist(SpecialistType::REVERED_ELDER)) return;
