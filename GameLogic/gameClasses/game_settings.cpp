...
void GameSettings::loadDefaults() {
    ...
    GameSettings::specialistDescriptions = {
        ...
        { ASSASSIN, "At the end of combat, kill all enemy specialists." },
        ...
        { INSPECTOR, "While at an outpost, instantly recharge the shield upon arrival and after combat." },
        ...
        { TYCOON, "Unit production speed is increased by 50%, with diminishing returns for stacked Tycoons. When at a factory, 3 additional units are produced." },
        ...
        { CHANCELLOR, "All global specialist abilities relating to speed or combat are canceled within standard sonar range every 2 hours." },
